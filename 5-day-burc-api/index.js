...
API_URI_1 = ""; //burada günlük yorumları
API_URI_2 = ""; // burada get değerine göre burcun haftalık,aylık,yıllık yorumunu alacağız
API_URI_3 = "";
      ...
      $(".col-md-12.col-lg-8").each(function (i, e) {
        datas[i] = {
          ...
          Baslik: $(this)
            ...
            .text()
            .match(/(.*)\"(.*)\.(.*)/)[2],
          Yorum: $(this).find("div div p").text(),
          Unluler: $(this).find("div div ul li").text(),
        };
      });
    });
